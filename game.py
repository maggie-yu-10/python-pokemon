...
def attack_click():
    ...
    b1 = Button(image=b1_photo, command=lambda: one_turn(msg_lb, 'soylent',
    ...
    b2 = Button(window, image=b2_photo, command=lambda: one_turn(msg_lb, 'attack OH',
                                                                 10, health1, health2, end_frame))
    b2.image = b2_photo
    ...
    b3 = Button(image=b3_photo, command=lambda: one_turn(msg_lb, 'attack code',
    ...
    b4 = Button(window, image=b4_photo, command=lambda: one_turn(msg_lb, 'attack cry',
